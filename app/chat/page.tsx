                          ...
                          >
                            <div className="main-navigation ast-inline-flex">
                              ...
                              >
                                ...
                                <li className="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item current_page_item menu-item-chat">
                                  <Link href="/chat" aria-current="page" className="menu-link">
                                    Flow AI
                                  </Link>
                                </li>
                              </ul>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div 
            ...
            style={{
            background: messages.length === 0 ? 'transparent' : 'rgba(255, 255, 255, 0.08)',
            backdropFilter: messages.length === 0 ? 'none' : 'blur(24px)',
            borderRadius: messages.length === 0 ? '50px' : '32px',
            border: messages.length === 0 ? 'none' : '1px solid rgba(255, 255, 255, 0.15)',
            ...
            overflow: 'hidden',
            position: 'relative',
            minHeight: messages.length === 0 ? 'auto' : '600px',
